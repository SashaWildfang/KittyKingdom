...
export default async function AccountPage({
  ...
  searchParams: { account?: string; discord?: string; verify?: string };
}) {
  ...
  const status =
    searchParams.account ?? searchParams.discord ?? searchParams.verify;
    ...
    <main className="auth-screen">
      ...
      <section className="auth-card account-card" aria-label="Account settings">
        ...
        <p className="auth-intro">
          Finish your member profile, create a username, and link Discord.
        </p>
