...
const statusMessages: Record<string, string> = {
  ...
  "database-unreachable": "The account database is not reachable right now. Please try again after the database network settings are updated.",
};
    ...
    <main className="auth-screen">
      ...
      <section className="auth-card minehut-card" aria-label="Register">
        ...
        <form className="auth-form" action="/api/account/register" method="post">
          <label>
            <span className="input-label">Email <span className="required-mark">*</span></span>
